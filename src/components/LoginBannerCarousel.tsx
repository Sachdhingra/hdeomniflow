...
const LoginBannerCarousel = () => {
  ...
  return (
    <div className="login-banner-container relative overflow-hidden bg-muted m-0 p-0 shrink-0">
      <div className="w-full aspect-[16/7] sm:aspect-[21/8] md:aspect-[21/7] max-h-[240px]">
        {b.link_url ? (
