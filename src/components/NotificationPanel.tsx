...
import { Bell, Truck, AlertCircle, CheckCircle, Info, History, Target, Clock, ClipboardList } from "lucide-react";
...
const ICON_MAP: Record<string, React.ReactNode> = {
  ...
  order_approval: <ClipboardList className="w-4 h-4 text-primary" />,
  order_service: <ClipboardList className="w-4 h-4 text-primary" />,
  order_approval_reminder: <Clock className="w-4 h-4 text-warning" />,
  order_service_reminder: <Clock className="w-4 h-4 text-warning" />,
};
